<template>
<el-dialog :title="info.isAdd ? '添加属性':'修改属性'" @close="cancel" :visible.sync="info.isShow" width="40%">
    <!-- 表单 -->
    <el-form :model="forminfo" ref="form" :rules="rules" label-width="140px">
        <el-form-item label="属性名" prop="specsname">
            <el-input v-model="forminfo.specsname" placeholder="请输入属性名称"></el-input>
        </el-form-item>
        <el-form-item label="属性值" prop="specsattr">
            <label v-for="(item,index) in list " :key="index">
                <el-input style="dispaly:block;width:300px;margin-bottom:10px" v-model="item.value" placeholder="请输入属性值"></el-input>
